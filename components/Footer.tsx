        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 lg:col-span-2">
             ...
             <p className="text-gray-400 text-lg leading-relaxed max-w-md">
               ...
               <span className="text-white font-medium">Milled in Mississippi. Stocked in Nashville.</span>
             </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="font-semibold">Nashville Warehouse</p>
                <p className="text-gray-400 text-sm">123 Timber Lane<br/>Nashville, TN 37209</p>
              </div>
            </div>

            <div className="flex items-center space-x-3">
              <Phone className="w-5 h-5 text-gray-400 flex-shrink-0" />
              <p className="text-gray-300 hover:text-white transition-colors cursor-pointer">(615) 555-0199</p>
            </div>
          </div>
